            ...
            <div className="mx-auto max-w-7xl px-8 grid grid-cols-2 gap-x-16">
                        ...
                        <div className="mt-6 flex items-center">
                            {product.inStock > 0 ? (
                                <>
                                    ...
                                    <p className="ml-2 text-sm text-gray-500">{product.inStock} in stock and ready to ship</p>
                                </>
                            ) : (
                                <>
                ...
                <div className="mt-10">
                    <div className="aspect-h-1 aspect-w-1 overflow-hidden rounded-lg">
                        {product.imageSrc && <Image src={product.imageSrc} alt={product.name} height={600} width={400} className="object-cover object-center"/>}
                    </div>
                </div>
